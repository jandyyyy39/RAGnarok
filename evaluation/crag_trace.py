...
Usage:
    python evaluation/crag_trace.py -p local
    python evaluation/crag_trace.py -p groq
    python evaluation/crag_trace.py -p groq -q "I try to grapple the guard"
    python evaluation/crag_trace.py -p groq -i 2       # run test case #2 from test_cases.json
"""
...
def main():
    ...
    parser.add_argument("-i", "--id", type=int, default=None,
                        help="Test case ID from evaluation/test_cases.json (1-50)")
